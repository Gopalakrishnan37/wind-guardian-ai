...
export function WindStationDashboard() {
  ...
  const toggleRelay = () => { if (automatic) return; const next = !relayOn; setRelayOn(next); addLog(`Operator switched relay ${next ? "ON" : "OFF"}`, next ? "normal" : "warning", "MANUAL"); };
